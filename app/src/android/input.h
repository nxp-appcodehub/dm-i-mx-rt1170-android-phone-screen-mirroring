// copied from
// <https://android.googlesource.com/platform/frameworks/native/+/master/include/android/input.h>
...
enum android_motionevent_axis {
	 ...
	 *
	 * - For a touch screen or touch pad, reports the approximate pressure applied to the
	 * surface by a finger or other tool.  The value is normalized to a range from 0 (no
	 * pressure at all) to 1 (normal pressure), although values higher than 1 may be generated
	 ...
	 * The units are device-dependent.
	 *
	 * When the touch is circular, the major and minor axis lengths will be equal to one
	 * another.
	 */
